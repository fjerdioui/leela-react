        ...
        <div className="phone-and-list-container">
          <div className="phone-frame">
            <div className="map-container">
              <MapWithList selectedPartyId={selectedPartyId} setSelectedPartyId={setSelectedPartyId} />
            </div>
          </div>
          <div className="list-container">
            <PartyList selectedPartyId={selectedPartyId} onPartySelect={setSelectedPartyId} />
          </div>
        </div>
      </div>
      <Routes>
